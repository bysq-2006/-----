...
def _configure_h264_hardware_encoding():
    ...
    encoder_options = {
        'h264_nvenc': {"preset": "p4", "tune": "ll", "profile": "baseline", "rc": "cbr", "zerolatency": "1"},
            ...
            if self.codec is None:
                ...
                try:
                    ...
                    if encoder_to_use == 'libx264':
                        ...
                        self.codec.options = {"preset": "p4", "tune": "ll", "profile": "baseline", "rc": "cbr", "zerolatency": "1"}
